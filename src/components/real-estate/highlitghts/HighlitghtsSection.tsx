...
const STEPS: Step[] = [
  {
    number: 1,
    title: "+70%",
    cardTitle: "Eficiencia Operativa",
    description: (
      <>
        Reducción en tiempo de espera para consultas de propiedades y atención al cliente.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Atención ininterrumpida para clientes internacionales en múltiples idiomas.
      </>
    ),
  },
  {
  ...
  },
  {
    number: 4,
    title: "+40%",
    cardTitle: "Leads Calificados",
    description: (
      <>
        Aumento en leads calificados y oportunidades de venta con atención personalizada.
      </>
    ),
  },
]
...
const HighlightSection: React.FC<ProcessSectionProps> = ({
  ...
  const headerConfig = {
    ...
    title: "Marca la diferencia con",
    titleHighlight: "LucIA",
    titleLayout: 'same-line',
    boldText: "En Sarex",
    description: "diseñamos agentes de voz con inteligencia artificial que actúan como un miembro más de tu equipo."
  } as const
