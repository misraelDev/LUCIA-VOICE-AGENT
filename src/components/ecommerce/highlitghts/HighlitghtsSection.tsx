...
const STEPS: Step[] = [
  {
    ...
    description: (
      <>
        Reducción en tiempo de espera para consultas de productos y soporte al cliente.
      </>
    ),
  },
  {
  ...
  },
  {
    number: 4,
    title: "40%",
    cardTitle: "Ventas Inteligentes",
    description: (
      <>
        Aumento en ventas con recomendaciones personalizadas y cross-selling inteligente.
      </>
    ),
  },
]
...
const HighlightSection: React.FC<ProcessSectionProps> = ({
  ...
  const headerConfig = {
    ...
    titleHighlight: "transforman ecommerce",
    titleLayout: 'same-line',
    boldText: "En Sarex",
    description: "Tiendas online que implementan Lucía experimentan mejoras significativas en conversión y satisfacción del cliente."
  } as const
  return (
    <SectionWithGrid
      id="como-heading"
