...
const TESTIMONIALS_DATA = [
  {
    image: "/testimonials/hotel.png",
    brandLogo: "/testimonials/hotellogo.png",
    text: "Las reservas se cancelaban o no se concretaban.\nCon la implementación de LucIA se hizo el seguimiento a cada cliente para garantizar las reservas.",
