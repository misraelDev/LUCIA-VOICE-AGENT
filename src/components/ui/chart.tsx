...
function useChart() {
  ...
  if (!context) {
    throw new Error(
      "useChart must be used within a <ChartContainer /> or <ChartRoot />",
    )
  }
...
/**
 * Mismo contexto/estilos que ChartContainer pero sin ResponsiveContainer.
 * Útil con `useStableChartWidth` + LineChart width/height fijos (p. ej. pestaña minimizada).
 */
function ChartRoot({
  id,
  className,
