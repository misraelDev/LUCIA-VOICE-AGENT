...
const FAQS: FaqItem[] = [
  {
    q: "¿Puede Lucía integrarse con mi CRM y sistema de ventas?",
    a: (
      <>
        Sí, Lucía se integra perfectamente con los principales CRM como Salesforce, HubSpot, 
        Pipedrive y otros. Puede sincronizar leads, consultar oportunidades en tiempo real y actualizar 
        información de clientes automáticamente.
      </>
    ),
  },
  {
    q: "¿Puede Lucía ayudar con el proceso de agendamiento de reuniones?",
    a: (
      <>
        Absolutamente. Lucía puede guiar a los clientes a través del proceso de agendamiento, verificar 
        disponibilidad de horarios, coordinar con vendedores y enviar confirmaciones automáticas. 
        También puede manejar reprogramaciones y cancelaciones.
      </>
    ),
  },
  {
    q: "¿Cómo maneja Lucía las consultas específicas sobre productos?",
    a: (
      <>
        Lucía puede responder preguntas detalladas sobre características de productos, sugerir alternativas 
        basándose en las necesidades del cliente, explicar precios y ofertas, y ofrecer 
        recomendaciones personalizadas. Para consultas complejas, transfiere automáticamente al equipo de ventas.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Lucía puede sugerir productos complementarios, ofrecer información sobre nuevas ofertas en el mercado, 
        recordar productos favoritos y promocionar descuentos especiales basándose en las preferencias del cliente. 
        Esto genera más oportunidades de venta de manera natural.
      </>
    ),
  },
]
    ...
    <section aria-labelledby="faq-heading" className="w-full bg-[#f8f8f8]">
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:py-20 md:py-24">
        ...
        <SectionHeader
          ...
          titleHighlight="Lucía para ventas?"
