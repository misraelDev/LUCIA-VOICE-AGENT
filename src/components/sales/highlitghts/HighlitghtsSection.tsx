...
const STEPS: Step[] = [
  {
    ...
    description: (
      <>
        Reducción en tiempo de espera para consultas de ventas y atención al cliente.
      </>
    ),
  },
  {
  ...
  },
  {
    number: 4,
    title: "40%",
    cardTitle: "Conversión de Leads",
    description: (
      <>
        Aumento en conversión de leads y oportunidades de venta con atención personalizada.
      </>
    ),
  },
]
...
const HighlightSection: React.FC<ProcessSectionProps> = ({
  ...
  const headerConfig = {
    ...
    titleHighlight: "transforman ventas",
    titleLayout: 'same-line',
    boldText: "En Sarex",
    description: "Equipos de ventas que implementan Lucía experimentan mejoras significativas en conversión de leads y satisfacción del cliente."
  } as const
  return (
    <SectionWithGrid
      id="como-heading"
